...
public class FilmeController {
	 ...
	 */
	public Filme sortear(String diretor, String genero, double notaMinima, int numeroVotosMinimo) throws Exception {
		//TODO consulta filmes que se encaixem no critério ou parametros informados
	
		List<Filme> filmes = filmeDAO.consultar(diretor,genero,notaMinima,numeroVotosMinimo);
	...
	public List<Filme> getAll() throws Exception {
		List<Filme> filmes = filmeDAO.consultar();
		return filmes;
	}

	public void criarFilme(Filme f) throws Exception {
		filmeDAO.adicionar(f);
	}

	public Filme consultarFilme(Integer id) {
		// TODO Auto-generated method stub
		return null;
	}
	
	public Set<String> getListaDeGeneros() throws Exception{
		return filmeDAO.getTodosGeneros();
	}
