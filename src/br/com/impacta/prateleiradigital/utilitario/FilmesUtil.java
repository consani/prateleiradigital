...
public class FilmesUtil {
	...
	public static void extrairGeneros(Set<String> listGeneros, String generos) {
		String[] splittedGeneros = generos.split("\\s*,\\s*"); //qualquer quantidade de espaços antes ou depois da virgula que separa os generos
