...
public class Filme implements Comparable<Filme> {
		 ...
		 */
		public Filme(int id, String titulo, String diretores, double nota, int duracao, int ano, String generos, int numVotos, String url) throws IllegalArgumentException {
			this(titulo,diretores,nota,duracao,ano,generos,numVotos,url);
			this.setId(id);
		}
